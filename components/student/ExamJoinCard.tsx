...
export default function ExamJoinCard({ initialCode = '', onExamFound }: ExamJoinCardProps) {
  ...
  return (
    <div className="w-full max-w-xl mx-auto rounded-3xl border border-zinc-800 bg-zinc-900/90 shadow-2xl p-6 sm:p-8 backdrop-blur-xl">
      {/* Header */}
      <div className="text-center mb-6">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-tr from-emerald-500 to-teal-400 text-zinc-950 shadow-lg shadow-emerald-500/20 mb-3">
          <KeyRound className="h-7 w-7" />
        </div>
        <h2 className="text-2xl font-black tracking-tight text-white">Enter Exam Portal</h2>
      ...
      {errorMsg && (
        <div className="mb-5 flex items-start gap-2.5 rounded-xl border border-rose-800/80 bg-rose-950/40 p-3.5 text-xs text-rose-300">
      ...
      <form onSubmit={handleProceed} className="space-y-4">
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              <input
                ...
                className="w-full rounded-xl border border-zinc-700 bg-zinc-950 px-4 py-3 text-base sm:text-lg font-mono font-bold tracking-wider text-white placeholder-zinc-500 focus:border-emerald-500 focus:outline-none"
              />
            </div>
            <button
              type="button"
              onClick={() => handleLookupExam(accessCode)}
              className="rounded-xl bg-zinc-800 border border-zinc-700 px-4 py-3 text-xs font-semibold text-zinc-200 hover:text-white hover:bg-zinc-700 transition-colors"
            >
              Verify
            </button>
          </div>
        ...
        {matchedExam && (
          <div className="rounded-2xl border border-emerald-800/60 bg-emerald-950/20 p-4 animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-start justify-between gap-3">
              <div>
                <span className="rounded bg-emerald-950 border border-emerald-700/50 px-2 py-0.5 text-[10px] font-bold text-emerald-300 uppercase">
                  Exam Verified
                </span>
                <h3 className="text-sm font-bold text-white mt-1.5">{matchedExam.title}</h3>
            ...
            {matchedExam.sharingSettings.passcode && (
              <div className="mt-3 pt-3 border-t border-emerald-900/40">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-zinc-700 bg-zinc-950 px-3 py-2 text-xs text-white focus:outline-none focus:border-emerald-500"
                />
              </div>
            )}
          </div>
          ...
          <div>
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-zinc-700 bg-zinc-950 pl-10 pr-4 py-2.5 text-xs sm:text-sm text-white placeholder-zinc-500 focus:border-emerald-500 focus:outline-none"
              />
            </div>
          </div>
        ...
        <button
          ...
          className="w-full mt-4 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-500 px-5 py-3.5 text-sm font-bold text-zinc-950 shadow-xl shadow-emerald-500/20 hover:from-emerald-500 hover:to-teal-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
        >
        ...
        <div className="pt-4 border-t border-zinc-800 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            <button
              ...
              className="rounded-lg bg-zinc-800 border border-zinc-700 px-2.5 py-1 text-[11px] font-mono text-zinc-300 hover:bg-zinc-700 hover:text-white"
            >
